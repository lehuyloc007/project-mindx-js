...
class PostsCarousel {
    ...
    constructor(fileImages, postsId) {
        if(fileImages.length > 1) {
            ...
            this.$carouselBtnLeft.setAttribute("data-bs-target", "#carousel" + postsId);
            ...
            this.$carouselItemRight.setAttribute("data-bs-target", "#carousel" + postsId);
            ...
            commonJsAddClass(this.$container, "listImagesPosts")
            fileImages.forEach((item, index) => {
                const carouselItem = commonJsCreateEl("div");
                const carouselItemImg = commonJsCreateEl("img");
                commonJsAddClass(carouselItemImg, "d-block", "w-100");
